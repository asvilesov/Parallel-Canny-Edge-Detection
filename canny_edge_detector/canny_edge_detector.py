...
class cannyEdgeDetector:
    ...
    def detect(self):
        ...
        for i, img in enumerate(self.imgs):   
            ...
            non_max = timer() - start - gauss - grad
            self.thresholdImg = self.threshold(self.nonMaxImg)
            thresh = timer() - start - gauss - grad - non_max
            img_final = self.hysteresis(self.thresholdImg)
            hyst = timer() - start - gauss - grad - non_max - thresh
            end = timer() - start
            print("Total: " + str(end) + "1. Gaussian: " + str(gauss) + "2. Gradient: " + str(grad)+ "3. Non-Max-Supression: " + str(non_max)+ "4. Thresholding: " + str(thresh) + "5. Hysteresis: " + str(hyst) + "\n")
